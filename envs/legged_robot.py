...
class LeggedRobot(BaseTask):
    ...
    def check_termination(self):# 检查是否满足重置复位条件
    ...
    def compute_reward(self):# 计算每一个环境当前时刻的总奖励
        """ Compute rewards
    ...
    def compute_cost(self):# 计算每一个环境当前时刻的总代价
        self.cost_buf[:] = 0
    ...
    def reset_idx(self, env_ids):# 重置指定环境
